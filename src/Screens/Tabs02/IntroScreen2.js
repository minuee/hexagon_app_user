        ...
        return(
            <SafeAreaView style={ styles.container }>
                ...
                >
                    ...
                    {
                        this.state.categoryNormalList.length === 0 ? 
                        <View style={styles.emptyWrap} >
                            <CustomTextR style={CommonStyle.dataText}>등록된 카테고리가 없습니다.</CustomTextR>
                        </View>
                        :
                        this.state.categoryNormalList.map((item, index) => {  
                            return (
...
export default connect(mapStateToProps,mapDispatchToProps)(IntroScreen2);