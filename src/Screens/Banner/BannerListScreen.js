...
const mockData1 = [
    ...
    { id: 4, icon : require('../../../assets/images/sample006.png'),title : '공지공지공지공지공지공지공지공지공지공지',date : '2020.12.03 11:30',content:'22222222',seq:4},
    { id: 5, icon : require('../../../assets/images/sample003.png'),title : '공지공지공지공지공지공지공지공지공지공지',date : '2020.12.03 11:30',content:'22222222',seq:5},
            ...
            <SafeAreaView style={ styles.container }>
                ...
                >
                    <View style={styles.boxWrap}>
                        <CustomTextM style={{fontSize:PixelRatio.roundToNearestPixel(DEFAULT_TEXT.fontSize15)}}>배너 목록({mockData1.length}/5)</CustomTextM>
                                    ...
                                    <TouchableOpacity style={styles.boxSubWrap} onPress={()=>this.moveDetail(item)}>
                                        ...
                                        <View style={styles.boxRightWrap}>
                                            ...
                                            <View style={{alignItems:'flex-end'}}>
                                                <CustomTextR style={[styles.menuTitleText2,{paddingLeft:20}]}>
                                                    {item.seq}/{mockData1.length}
                                                </CustomTextR>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
...
export default connect(mapStateToProps,null)(BannerListScreen);