...
import { Text, StyleSheet, TouchableOpacity, View, FlatList, Image, Dimensions, Animated, Platform, Alert, PixelRatio } from 'react-native';
                ...
                />
                {
                    ...
                    <View style={{width:80, alignItems:'center',justifyContent:'center'}}>
                        <Image
                            ...
                            style={{width: 60,height: undefined,aspectRatio: 135 / 76,}}
                        />
                    </View>
                    ...
                    preSelectedItem.length > 0
                        ? (
                            ...
                            <View style={{flexDirection:'row',flexGrow:1}}>
                                {preSelectedItem[0].logo != null  &&
                                    <Image  
                                        source={{uri:preSelectedItem[0].logo}}
                                        style={{height:20}}
                                    />
                                }
                                <Text style={[styles.selectedTitlte, this.defaultFont, selectedTitleStyle]}>
